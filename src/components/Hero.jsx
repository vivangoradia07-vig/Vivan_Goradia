...
const Hero = () => {
  ...
  const introText = "Hi, I'm Veevan Goradia. I'm a Full Stack Developer passionate about creating modern web applications and digital experiences. I enjoy turning ideas into real products using technologies like HTML, CSS, JavaScript, React, Next.js, Tailwind CSS, Node.js, and MongoDB.";
...
/*
  ...
  return (
    <section ref={heroRef} id="home" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-white pt-20">
      <div className="container mx-auto px-6 md:px-12 flex flex-col-reverse lg:flex-row items-center justify-between h-full">
        ...
        <div ref={textRef} className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
          ...
          <button
            ...
            className="mt-6 rounded-full border border-black/10 bg-black px-5 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-primary"
          >
            {isSpeaking ? 'Pause Intro' : isPaused ? 'Resume Intro' : 'Hear Intro'}
          </button>
