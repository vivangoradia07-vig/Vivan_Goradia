...
const Projects = () => {
  ...
  return (
    <section ref={containerRef} id="portfolio" className="relative min-h-[100svh] md:h-screen w-full bg-[#f7f6f2] overflow-hidden flex items-center justify-center pt-20 perspective-[2000px]">
